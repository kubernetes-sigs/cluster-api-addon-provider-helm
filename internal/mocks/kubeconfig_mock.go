...
//
//	mockgen -destination kubeconfig_mock.go -package mocks -source ../kubeconfig.go Getter
//
...
func (m *MockGetter) GetClusterKubeconfig(ctx context.Context, clusterKey client.ObjectKey) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClusterKubeconfig", ctx, clusterKey)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockGetterMockRecorder) GetClusterKubeconfig(ctx, clusterKey any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClusterKubeconfig", reflect.TypeOf((*MockGetter)(nil).GetClusterKubeconfig), ctx, clusterKey)
}
